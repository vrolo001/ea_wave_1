---
title: "Survey 2: Data Simulation (coding/scoring)"
format: html
editor: visual
---

This document includes the code to simulate a dataset for Survey 2 of Wave 1 of the Explaining Atheism project.

Survey 2 includes the Cognitive Styles cluster of variables, along with some response variables. We will generate the dataset with our custom easim function.
...
```{r}
write.csv(df, "survey2_testdat_sc.csv", row.names = FALSE)
```
