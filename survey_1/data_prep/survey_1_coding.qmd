...
write.csv(survey1_coded, "survey_1_coded_FAKE.csv")
```
...
survey_1_scored <- survey1_coded %>%
  mutate(
    ...
    apx1 = as.numeric(apth_01),  #was buggy using as numeric within rowMeans so these are for computing apatheism (combined)
