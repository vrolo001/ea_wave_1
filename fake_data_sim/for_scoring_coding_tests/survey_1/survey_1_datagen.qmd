---
title: "Survey 1: Data Simulation (coding/scoring)"
format: html
editor: visual
---

This document includes the code to simulate a dataset for Survey 1 of Wave 1 of the Explaining Atheism project.

Survey 1 includes the Morals and Values cluster of variables, along with some response variables. We will generate the dataset with our custom easim function.
...
```{r}
write.csv(df, "survey1_testdat_sc.csv", row.names = FALSE)
```
