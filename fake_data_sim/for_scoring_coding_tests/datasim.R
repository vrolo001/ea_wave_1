...
#easim samples randomly easim2 just repeats the vector instead, and easim_odd repeats the vector, but in the reverse order for odd numbers
...
possible_rlabs <- list(
      ...
      extent = c("1 - To No Extent At All", "2", "3", "4", "5", "6", "7 - To a Great Extent"),
      yesno = c("Yes", "No"),
      truefalse = c("True", "False"),
      frequency = c("Never", "Very Infrequently", "Infrequently", "Sometimes", "Frequently", "Very Frequently", "Always")
    )

#and assign it back to rlab

rlab <- possible_rlabs[[rlab]]
