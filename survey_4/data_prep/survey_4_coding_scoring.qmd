...
survey_4_coded <- funScore(survey4, sdcols, "truth", FALSE)

#coding reversed items

survey_4_coded <- funScore(survey_4_coded, sdcolsrev, "truth", TRUE)
...
survey_4_coded <- funScore(survey_4_coded, escols, "frequency", FALSE)
...
survey_4_coded <- funScore(survey_4_coded, sswist, "agreement", FALSE)
...
#coding normal items
survey_4_coded <- funScore(survey_4_coded, nfscols, "agreement", FALSE)

#coding reversed items
survey_4_coded <- funScore(survey_4_coded, nfscolsrev, "agreement", TRUE)
...
survey_4_coded <- funScore(survey_4_coded, dacols, "agreement", FALSE)
...
survey_4_coded <- funScore(survey_4_coded, nfmcols, "agreement", FALSE)
survey_4_coded <- funScore(survey_4_coded, nfmcolsrev, "agreement", TRUE)
...
survey_4_coded <- funScore(survey_4_coded, mlqcols, "truth", FALSE)
survey_4_coded <- funScore(survey_4_coded, mlqcolsrev, "truth", TRUE)
...
#    soc_network_size = sns_num,
    ...
    #Disgust Sensitivity
    disgust_sens = rowMeans(across(starts_with("ds_"), ~ as.numeric(.))),

    #Disgust Sensitivity (core)
    digust_core = rowMeans(across(paste0("ds_", sprintf("%02d",c(1, 2, 3, 4, 5, 12, 14, 15, 16, 17, 18, 23))))),

    #Disgust Sensitivity (animal)
    digust_animal = rowMeans(across(paste0("ds_", sprintf("%02d",c(6, 7, 8, 9, 13,19,20))))),
