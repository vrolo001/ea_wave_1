...
source("../../funs/scoringFuns.R")  #these functions require some tidyverse elements
...
`funScore` and `funScore2` are functions to **code** (excuse the incorrect naming!!!) our survey responses, ready for scoring. funScore will score numerically, and funScore2 will create factors.
...
survey_5_coded <- funScore(survey5, anthcols, "agreement", FALSE)
...
survey_5_coded <- funScore(df = survey_5_coded,
                           cols = mntcols,
...
survey_5_coded <- funScore(survey_5_coded,
                           duacols,
                           "agreement",
                           FALSE)
#reversed
